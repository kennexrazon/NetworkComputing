...
#    if delayh > 0:
#        end = end - timedelta(hours=delayh)
#        start = start - timedelta(hours=delayh)
#        offsetstart = offsetstart - timedelta(hours=delayh)
#        
#    if delayd > 0:
#        end = end - timedelta(hours=delayd)
#        start = start - timedelta(hours=delayd)
#        offsetstart = offsetstart - timedelta(hours=delayd)
